	...
	if (fp != NULL) {
	   ...
	   while(fgets(line,sizeof line,fp)!= NULL) {// read a line from a file
		   if (line[0] != '%') {
			   ...
			   *x        = (DATA_TYPE*)aligned_alloc(4096, *col_size*sizeof(DATA_TYPE));

			   *values_indices_1 = (uintbuswidth_t*)aligned_alloc(4096, *compact_indices_size *sizeof(uintbuswidth_t));
			   *values_indices_2 = (uintbuswidth_t*)aligned_alloc(4096, *compact_indices_size *sizeof(uintbuswidth_t));
			   *values_indices_3 = (uintbuswidth_t*)aligned_alloc(4096, *compact_indices_size *sizeof(uintbuswidth_t));
			   *values_indices_4 = (uintbuswidth_t*)aligned_alloc(4096, *compact_indices_size *sizeof(uintbuswidth_t));
...
//	uintbuswidth_t *x            = NULL;
	...
	y_union.d_128bit = (uintbuswidth_t*)aligned_alloc(4096, (row_size/4)*sizeof(uintbuswidth_t));
